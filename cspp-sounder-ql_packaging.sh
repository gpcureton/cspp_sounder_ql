...
tar cvhf cspp-sounder-ql-$version.tar --exclude=__pycache__ --exclude=*.pyc --exclude=.git* --exclude=oldstuff --exclude=ShellB3 --exclude=env --exclude=tag_version.sh --exclude=dummy_file --exclude=.vim $pkg_dir_link 

#!/bin/bash
# $Id: ql_level2_skewt.sh 2354 2015-02-12 06:59:24Z geoffc $
#
...
usage() {
    $PY $CSPP_SOUNDER_QL_HOME/sounder_ql/sounder_skewt.py --help
}
...
$PY $CSPP_SOUNDER_QL_HOME/sounder_ql/sounder_skewt.py  -zz "$@"

...
class Mirs(Sounder_Packages):
    ...
    def __init__(self, *args, **kwargs):
        ...
        satellite_names = {b'_ma1_': u'Metop-B',
                           b'_ma2_': u'Metop-A',
                           b'.M1.': u'Metop-B',
                           b'.M2.': u'Metop-A',
                           b'.NN.': u'NOAA-15',
        ...
        for filename in self.datasets['file_attrs'].keys():
            for key in satellite_names.keys():
                if key.decode('utf-8') in filename:
                    self.datasets['file_attrs'][filename]['Satellite_Name'] = satellite_names[key]
                    break
    ...
    def pressure_array_old(self,dfile_obj,data_name,level,row,col,this_granule_data,this_granule_mask):
        '''
        Custom method to return an array of the pressure, whether it be at a single
        pressure level, or a vertical slice.
        '''
